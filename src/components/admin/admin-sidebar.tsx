...
const menuItems = [
  ...
  { name: "Actividad", href: "/admin/logs", icon: FileText },
  { 
    name: "Editar Home",
    ...
    <div className="flex flex-col h-full justify-between">
      ...
      <div>
        <div className="px-6 py-6 border-b border-gray-100">
          <h1 className="text-xl font-black tracking-tight text-gray-900 mb-4">Admin Panel</h1>
      ...
      <div className="p-4 border-t border-gray-100 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-red-500 transition-all hover:bg-red-50"
        >
...
// Export por defecto añadido para compatibilidad con imports antiguos
